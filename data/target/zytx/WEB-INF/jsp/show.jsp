...
<body>
	...
	<div class="container">
		...
		<div class="row" style="height: 30px">
			<div class="col-md-3">电梯编号：&nbsp;&nbsp;&nbsp;&nbsp; ${registNumber}</div>
			...
			<div class="col-md-offset-3">
				<div id="myTabContent" class="tab-content">
					...
					<div class="tab-pane fade in active" id="year_pane">
						查询年数据:&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="text" id="year" placeholder="请点击查询的年份">&nbsp;&nbsp; 
						<input type="button" value="查询" id="searcYear"></p>
					</div>
					
					<div class="tab-pane fade" id="month_pane">
						查询月数据:&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="text" id="month" placeholder="请点击查询的月份">&nbsp;&nbsp;&nbsp;&nbsp; 
						<input type="button" value="查询" id="searchMonth">
					</div>
					
					<div class="tab-pane fade" id="day_pane">
						查询日数据:&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="text" id="day" placeholder="请点击查询的日期">&nbsp;&nbsp;&nbsp;&nbsp; 
						<input type="button" value="查询" id="searchDay">
					</div>
					
					<div class="tab-pane fade" id="dayInterval_pane">
						开始日期：&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="text" id="startTime" placeholder="请点击查询的开始日期">&nbsp;&nbsp;&nbsp;&nbsp;
						结束日期：&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="text" id="endTime" placeholder="请点击查询的结束日期">&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="button" value="查询" id="searchDays">
					</div>
			</div>
			</div>
		</div>
		...
		$.post("<%=basePath%>daysIntervalAbnormalNumbersData", 
				{
					...
					deviceID:deviceID
						...
						var abnormalNumbersChart = echarts.init(document
								.getElementById('abnormalNumbersChart'));
						var option = getBarOption(data,'异常次数统计','单位:天', "异常次数");
						abnormalNumbersChart.setOption(option);
						if(!data) {
							alert("没有数据");
